...
void main() {
  ...
  testWidgets('guest entry works without credentials and starts an empty session', (tester) async {
    await tester.pumpWidget(MaterialApp(theme: AppThemes.light, home: const LoginScreen()));
  ...
  testWidgets('search route shares basket state and last-item removal stays usable', (tester) async {
  ...
  testWidgets('catalog and basket tolerate larger text on a phone', (tester) async {
