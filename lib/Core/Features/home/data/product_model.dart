...
const allProducts = <ProductModel>[
  ProductModel(
    ...
    imageAsset: 'Assets/products/1.png',
  ),
  ProductModel(
    id: '2',
    name: 'Banana',
    ...
    imageAsset: 'Assets/products/2.webp',
  ),
  ProductModel(
    id: '3',
    name: 'Orange',
    ...
    imageAsset: 'Assets/products/3.webp',
  ),
  ProductModel(
    id: '4',
    name: 'Pineapple',
    ...
    imageAsset: 'Assets/products/4.webp',
  ),
  ProductModel(
    id: '5',
    name: 'Strawberry',
    ...
    imageAsset: 'Assets/products/5.jpg',
  ),
  ProductModel(
    id: '6',
    name: 'Mango',
    ...
    imageAsset: 'Assets/products/6.jpg',
  ),
  ProductModel(
    id: '7',
    name: 'Blueberry',
  ...
  ProductModel(
    ...
    imageAsset: 'Assets/products/11.png',
  ),
  ProductModel(
    id: '12',
    name: 'Potato',
  ...
  ProductModel(
    ...
    imageAsset: 'Assets/products/16.png',
  ),
  ProductModel(
    id: '17',
    name: 'Pepper',
...
final offers = List<ProductModel>.unmodifiable(
  allProducts.where((p) => p.category == ProductCategory.fruit),
);
final bestSelling = List<ProductModel>.unmodifiable(
  allProducts.where((p) => p.category == ProductCategory.vegetables),
);

List<ProductModel> getProductsByName(
  String searchKey, {
