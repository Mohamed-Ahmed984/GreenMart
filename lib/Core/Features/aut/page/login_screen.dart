    ...
    Navigator.pushAndRemoveUntil(
      ...
      MaterialPageRoute<void>(
        builder: (_) => MainAppScreen(
          email: guest ? null : _email.text.trim().toLowerCase(),
        ),
      ),
      (_) => false,
    );
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Demo sign-in only. No account is created or verified. Use sample details, or continue as a guest.',
                  ),
                  const SizedBox(height: 24),
                  TextFormField(
